...
public class ExperimentApachePoi {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Create a Sheet
        Sheet sheet = workbook.createSheet("se.perfektum.econostats.research.Employee");
        ...
        FileOutputStream fileOut = new FileOutputStream("c:/temp/testdata/poi-generated-file.xlsx");
