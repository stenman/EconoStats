...
public class NordeaCsvReaderTest {
    ...
    public void readCsvV1ShouldReturnAllLines() {
        ...
        assertThat(actual,
                hasItems(
                        new AccountTransaction.Builder().date(LocalDate.parse("2018-10-04", DateTimeFormatter.ISO_LOCAL_DATE))
                                ...
                                .receiver("")
                                .build(),
                        new AccountTransaction.Builder().date(LocalDate.parse("2018-10-03", DateTimeFormatter.ISO_LOCAL_DATE))
                        ...
                        new AccountTransaction.Builder().date(LocalDate.parse("2018-10-03", DateTimeFormatter.ISO_LOCAL_DATE))
                                ...
                                .receiver("")
                                .build(),
                        new AccountTransaction.Builder().date(LocalDate.parse("2018-09-25", DateTimeFormatter.ISO_LOCAL_DATE))
                                .header("Lön")
                                .category("")
    ...
    public void readCsvV2ShouldReturnAllLines() {
        ...
        assertThat(actual,
                hasItems(
                        new AccountTransaction.Builder().date(LocalDate.parse("2020-10-22", DateTimeFormatter.ISO_LOCAL_DATE))
                                ...
                                .receiver("")
                                .build(),
                        new AccountTransaction.Builder().date(LocalDate.parse("2020-09-29", DateTimeFormatter.ISO_LOCAL_DATE))
                                ...
                                .receiver("")
                                .build(),
                        new AccountTransaction.Builder().date(LocalDate.parse("2020-08-31", DateTimeFormatter.ISO_LOCAL_DATE))
                                .header("Betalning BG 1234-5678 Ankeborgs Elnät")
                                .category("")
                                ...
                                .receiver("")
                                .build(),
                        new AccountTransaction.Builder().date(LocalDate.parse("2020-08-02", DateTimeFormatter.ISO_LOCAL_DATE))
                                .header("ÖVF DOE,JOHN")
                                .category("")
                                ...
                                .build(),
                        new AccountTransaction.Builder().date(LocalDate.parse("2020-07-28", DateTimeFormatter.ISO_LOCAL_DATE))
